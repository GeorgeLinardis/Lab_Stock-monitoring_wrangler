...
Backend Cloudflare Worker for the Stock Monitoring app. It pairs with the React client at https://github.com/GeorgeLinardis/Stock-monitoring_client to serve market data and scoring results.
